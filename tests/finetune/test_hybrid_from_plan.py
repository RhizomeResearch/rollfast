...
def test_muon_manifest_marks_rollfast_profile_and_benchmark_gate():
    plan = tiny_plan()
    ...
    assert method_config["implemented_profile"] == "rollfast_muon"
    assert method_config["reference_algorithm"] == "muon_newton_schulz_matrix_momentum"
    assert method_config["matrix_optimizer"] == "rollfast.optim.muon"
    assert method_config["paper_profile"] is False
